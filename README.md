...
> NOTE: VRChat Android Assistant is still under development, you should report issues to our [discord](https://discord.com/invite/UEbkGVXD), or [here](https://github.com/Nyabsi/VRCAA/issues).
...
VRChat Android Assistant is an EXTERNAL modification and does not MODIFY or MANIPULATE the game, it is not against the [Terms of Service of VRChat](https://hello.vrchat.com/legal).
